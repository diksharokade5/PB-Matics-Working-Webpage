           ...
           <form name="f1" action="update_dayplan.jsp" method="POST">
   	 	...
   	 	<div class="form-group">
   	 		...
   	 		<div class="radio-inline">
                            ...
                            %>
   	 			<input type="radio" name="STATUS" value="<%=(data.equals("Urgent and Important")?"checked":"")%>">Urgent and Important
   	 		</div>
   	 		<div class="radio-inline">
   	 			<input type="radio" name="STATUS" value="<%=(data.equals("Not Urgent But Important")?"checked":"")%>">Not Urgent But Important
                        </div>
   	 	</div>
   	 		...
   	 		<div class="radio-inline">
   	 			<input type="radio" name="task" value="In Progress">In Progress
   	 		</div>
   	 		<div class="radio-inline">
   	 			<input type="radio" name="task" value="Task Completed">Task Completed
   	 		</div>
   	 		<div class="radio-inline">
   	 			<input type="radio" name="task" value="On Hold">On Hold
   	 		</div>
   	 	</div>
